...
app.get("/:channelId/manifest.mpd", (req, res) => {
  ...
  // Construct Go-to URL
  const goToURL = `http://143.44.136.67:6060/001/2/ch0000009099000000${channelId}/manifest.mpd?JITPDRMType=Widevine&JITPMediaType=DASH&virtualDomain=001.live_hls.zte.com&ztecid=ch00000090990000001093&m4s_min=1&usersessionid=189096448&IASHttpSessionId=RR20452520251204070100095540&NeedJITP=1&AuthInfo=${generateAuthInfo()}`;
