...
app.get("/:channelId/manifest.mpd", (req, res) => {
  ...
  // Construct Go-to URL
  const goToURL = `http://136.239.159.20:6610/001/2/ch0000009099000000${channelId}/manifest.mpd?JITPDRMType=Widevine&virtualDomain=001.live_hls.zte.com&m4s_min=1&ispcode=55&AuthInfo=${generateAuthInfo()}`;
